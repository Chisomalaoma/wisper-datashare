...
export const requestOTP = async (
  ...
  return defaultClient.post<RequestOTPResponse>(
    API_CONFIG.ENDPOINTS.AUTH.VERIFY_KYC,
    data
  );
};
...
export const registerUser = async (
  ...
  return defaultClient.post<RegisterResponse>(
...
export const loginUser = async (data: LoginRequest): Promise<LoginResponse> => {
  return defaultClient.post<LoginResponse>(
...
export const getUserProfile = async (): Promise<UserProfileResponse> => {
  return defaultClient.get<UserProfileResponse>(
